...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->setWindowTitle(QString::fromUtf8("Batalla Naval v0.17.01"));
        QIcon icon;
...
""));
        ...
        mapaJugador->setGeometry(QRect(0, 320, 661, 291));
        gridLayoutWidget_2 = new QWidget(mapaJugador);
        gridLayoutWidget_2->setObjectName(QString::fromUtf8("gridLayoutWidget_2"));
        gridLayoutWidget_2->setGeometry(QRect(110, 0, 501, 261));
        ...
        mapaAtaque->setGeometry(QRect(0, 30, 661, 281));
        gridLayoutWidget = new QWidget(mapaAtaque);
        gridLayoutWidget->setObjectName(QString::fromUtf8("gridLayoutWidget"));
        gridLayoutWidget->setGeometry(QRect(110, 10, 501, 241));
...
""));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        listaBarcos->setToolTip(QCoreApplication::translate("MainWindow", "<html><head/><body><p>A VER QUE VERGA ES ESTO</p></body></html>", nullptr));
